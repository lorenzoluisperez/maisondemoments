...
try {
  ...
  if (tables.total !== 32 || tables.rls_enabled !== 32) throw new Error("Every application table must have RLS enabled");
  ...
  if (migrations.total < 11) throw new Error("Expected Phase 5 migrations are not applied");
