...
try {
  ...
  if (tables.total !== 36 || tables.rls_enabled !== 36) throw new Error("Every application table must have RLS enabled");
  ...
  if (migrations.total < 20) throw new Error("Expected Phase 7 migrations are not applied");
