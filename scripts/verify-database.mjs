...
try {
  ...
  if (tables.total !== 33 || tables.rls_enabled !== 33) throw new Error("Every application table must have RLS enabled");
  ...
  if (migrations.total < 15) throw new Error("Expected Phase 6 migrations are not applied");
